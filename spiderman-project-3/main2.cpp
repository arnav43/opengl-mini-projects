// If you run this-> you will get a second object which increses and decreases in size overtime. check it out!
...
int main()
{
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // ======= Second Container (Stationary, top left corner, scaled down half) =======
        float scale_time = sin(time_trans); 
        glm::mat4 trans2 = glm::mat4(1.0f);
        trans = glm::translate(trans2, glm::vec3(-0.5f,0.5f, 1.0f));
        trans = glm::scale(trans, glm::vec3(scale_time, scale_time, scale_time)); // scale down then move
            
        unsigned int transformlocation2 = glGetUniformLocation(ourShader.ID, "transform");
